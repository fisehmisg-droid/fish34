-- ============================================================================
-- FINAL SUPABASE SCHEMA FOR ABEBE EUEE BOT
...
CREATE TABLE IF NOT EXISTS battles (
    ...
    FOREIGN KEY (challenger_id) REFERENCES users(telegram_id) ON DELETE CASCADE,
...
-- Indexes for real exam questions
CREATE INDEX IF NOT EXISTS idx_real_exam_questions_subject ON real_exam_questions(subject);
CREATE INDEX IF NOT EXISTS idx_real_exam_questions_topic ON real_exam_questions(topic);
